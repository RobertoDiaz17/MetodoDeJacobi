...
# Definir el nuevo sistema de ecuaciones (Ejercicio 3)
...
plt.ylabel("Error")
plt.yscale("log")
plt.title("Convergencia de los errores en el método de Jacobi (Ejercicio 3)")
plt.legend()
plt.grid()
plt.savefig("errores_jacobi_ej3.png")
plt.show()
